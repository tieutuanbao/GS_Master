# 1 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c" 2
# 38 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
...
# 39 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c" 2
# 56 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_deinit(uint32_t gpio_periph)
{
    switch(gpio_periph){
    case ((((uint32_t)0x40010000U) + 0x00000800U) + 0x00000000U):

        rcu_periph_reset_enable(RCU_GPIOARST);
        rcu_periph_reset_disable(RCU_GPIOARST);
        break;
    case ((((uint32_t)0x40010000U) + 0x00000800U) + 0x00000400U):

        rcu_periph_reset_enable(RCU_GPIOBRST);
        rcu_periph_reset_disable(RCU_GPIOBRST);
        break;
    case ((((uint32_t)0x40010000U) + 0x00000800U) + 0x00000800U):

        rcu_periph_reset_enable(RCU_GPIOCRST);
        rcu_periph_reset_disable(RCU_GPIOCRST);
        break;
    case ((((uint32_t)0x40010000U) + 0x00000800U) + 0x00000C00U):

        rcu_periph_reset_enable(RCU_GPIODRST);
        rcu_periph_reset_disable(RCU_GPIODRST);
        break;
    case ((((uint32_t)0x40010000U) + 0x00000800U) + 0x00001000U):
...
# 126 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_init(uint32_t gpio_periph, uint32_t mode, uint32_t speed, uint32_t pin)
{
    uint16_t i;
    ...
    if(((uint32_t)0x00U) != ((uint32_t)mode & ((uint32_t)0x10U))){
        ...
        if(((uint8_t)0x04U) == (uint32_t)speed){
            temp_mode |= (uint32_t)0x03U;

            (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x3CU)) |= (uint32_t)pin ;
        }else{
    ...
    for(i = 0U;i < 8U;i++){
        if((1U << i) & pin){
            reg = (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00U));


            reg &= ~(0xFU << (4U * (i)));

            reg |= ((uint32_t)((uint32_t)(temp_mode) << (4U * (i))));


            if(((uint8_t)0x28U) == mode){

                (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U)) = (uint32_t)((1U << i) & pin);
            }else{

                if(((uint8_t)0x48U) == mode){
                    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U)) = (uint32_t)((1U << i) & pin);
                }
            }

            (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x00U)) = reg;
        }
    }

    for(i = 8U;i < 16U;i++){
        if((1U << i) & pin){
            reg = (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x04U));


            reg &= ~(0xFU << (4U * (i - 8U)));

            reg |= ((uint32_t)((uint32_t)(temp_mode) << (4U * (i - 8U))));
            ...
            (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x04U)) = reg;
        }
    }
}
# 207 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_bit_set(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U)) = (uint32_t)pin;
}
# 221 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_bit_reset(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U)) = (uint32_t)pin;
}
# 238 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_bit_write(uint32_t gpio_periph, uint32_t pin, bit_status bit_value)
{
    if(RESET != bit_value){
        (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U)) = (uint32_t)pin;
...
# 254 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_port_write(uint32_t gpio_periph,uint16_t data)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0CU)) = (uint32_t)data;
}
# 268 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
FlagStatus gpio_input_bit_get(uint32_t gpio_periph,uint32_t pin)
{
    if((uint32_t)RESET != ((*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x08U))&(pin))){
        return SET;
    }else{
        return RESET;
    }
...
uint16_t gpio_input_port_get(uint32_t gpio_periph)
{
    return (uint16_t)((*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x08U)));
}
# 297 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
FlagStatus gpio_output_bit_get(uint32_t gpio_periph, uint32_t pin)
{
    if((uint32_t)RESET !=((*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0CU))&(pin))){
        return SET;
    }else{
        return RESET;
    }
...
uint16_t gpio_output_port_get(uint32_t gpio_periph)
{
    return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x0CU)));
}
# 354 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_pin_remap_config(uint32_t remap, ControlStatus newvalue)
{
    ...
    if(((uint32_t)0x80000000U) == (remap & 0x80000000U)){
        ...
        temp_reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x1CU));
    }else{

        temp_reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x04U));
    }

    temp_mask = (remap & ((uint32_t)0x000F0000U)) >> 0x10U;
    remap1 = remap & ((uint16_t)0xFFFFU);


    if((((uint32_t)0x00200000U) | ((uint32_t)0x00100000U)) == (remap & (((uint32_t)0x00200000U) | ((uint32_t)0x00100000U)))){
        temp_reg &= ((uint32_t)0xF8FFFFFFU);
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x04U)) &= ((uint32_t)0xF8FFFFFFU);
    }else if(((uint32_t)0x00100000U) == (remap & ((uint32_t)0x00100000U))){
    ...
    if(((uint32_t)0x80000000U) == (remap & ((uint32_t)0x80000000U))){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x1CU)) = temp_reg;
    }else{

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x04U)) = temp_reg;
    }
}
# 411 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_exti_source_select(uint8_t output_port, uint8_t output_pin)
{
    uint32_t source = 0U;
    source = ((uint32_t)0x0FU) << (((uint8_t)0x04U) * (output_pin & ((uint8_t)0x03U)));


    if(((uint8_t)0x04U) > output_pin){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x08U)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x08U)) |= (((uint32_t)output_port) << (((uint8_t)0x04U) * (output_pin & ((uint8_t)0x03U))));
    }else if(((uint8_t)0x08U) > output_pin){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x0CU)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x0CU)) |= (((uint32_t)output_port) << (((uint8_t)0x04U) * (output_pin & ((uint8_t)0x03U))));
    }else if(((uint8_t)0x0CU) > output_pin){

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x10U)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x10U)) |= (((uint32_t)output_port) << (((uint8_t)0x04U) * (output_pin & ((uint8_t)0x03U))));
    }else{

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x14U)) &= ~source;
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x14U)) |= (((uint32_t)output_port) << (((uint8_t)0x04U) * (output_pin & ((uint8_t)0x03U))));
    }
}
# 451 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_event_output_config(uint8_t output_port, uint8_t output_pin)
{
    uint32_t reg = 0U;
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U));


    reg &= (uint32_t)(~(((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6))))|((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3))))));

    reg |= (uint32_t)((uint32_t)output_port << ((uint32_t)4U));
    reg |= (uint32_t)output_pin;

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) = reg;
}
...
void gpio_event_output_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(7)));
}
...
void gpio_event_output_disable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(7))));
}
# 496 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_pin_lock(uint32_t gpio_periph, uint32_t pin)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U)) = (uint32_t)lock;
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U)) = (uint32_t)pin;
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U)) = (uint32_t)lock;
    lock = (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U));
    lock = (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U));
}
# 518 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_gpio.c"
void gpio_compensation_config(uint32_t compensation)
{
    uint32_t reg;
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x20U));


    reg &= ~((uint32_t)((uint32_t)0x01U<<(0)));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x20U)) = (reg | compensation);
}
...
FlagStatus gpio_compensation_flag_get(void)
{
    if(((uint32_t)RESET) != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x20U)) & ((uint32_t)((uint32_t)0x01U<<(8))))){
        return SET;
    }else{
        return RESET;
    }
