# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c" 2
# 37 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c"
# 1 "../source\\usbd_conf.h" 1
# 41 "../source\\usbd_conf.h"
...
# 42 "../source\\usbd_conf.h" 2
# 38 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Include\\drv_usbd_int.h" 1
# 40 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Include\\drv_usbd_int.h"
...
# 41 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Include\\drv_usbd_int.h" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Include/drv_usb_dev.h" 1
# 44 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Include/drv_usb_dev.h"
enum usb_ctl_status {
    USB_CTL_IDLE = 0U,
    USB_CTL_DATA_IN,
...
# 42 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Include\\drv_usbd_int.h" 2



void usbd_isr (usb_core_driver *udev);
# 39 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_transc.h" 1
# 40 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_transc.h"
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include/usbd_core.h" 1
# 43 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include/usbd_core.h"
typedef enum
{
    USBD_OK = 0U,
    USBD_BUSY,
...
# 41 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_transc.h" 2
...
# 40 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c" 2
...
static const uint8_t USB_SPEED[4] = {
    [0U] = (uint8_t)USB_SPEED_HIGH,
    [1U] = (uint8_t)USB_SPEED_FULL,
    [3U] = (uint8_t)USB_SPEED_FULL,
    [2U] = (uint8_t)USB_SPEED_LOW
};
...
void usbd_isr (usb_core_driver *udev)
{
    if (HOST_MODE != (udev->regs.gr->GINTF & ((uint32_t)((uint32_t)0x01U<<(0))))) {
        ...
        if (intr & ((uint32_t)((uint32_t)0x01U<<(19)))) {
            (void)usbd_int_epout (udev);
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(18)))) {
            (void)usbd_int_epin (udev);
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(11)))) {
            (void)usbd_int_suspend (udev);
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(31)))) {

            udev->dev.cur_status = USBD_CONFIGURED;


            udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(31)));
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(3)))) {
            if (udev->dev.class_core->SOF) {
                (void)udev->dev.class_core->SOF(udev);
            }


            udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(3)));
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(4)))) {
            (void)usbd_int_rxfifo (udev);
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(12)))) {
            (void)usbd_int_reset (udev);
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(13)))) {
            (void)usbd_int_enumfinish (udev);
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(20)))) {
            if (0 != udev->dev.class_core->incomplete_isoc_in) {
                (void)udev->dev.class_core->incomplete_isoc_in(udev);
            }


            udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(20)));
        }


        if (intr & ((uint32_t)((uint32_t)0x01U<<(21)))) {
            if (0 != udev->dev.class_core->incomplete_isoc_out) {
                (void)udev->dev.class_core->incomplete_isoc_out(udev);
            }


            udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(21)));
        }
# 161 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c"
    }
}
...
static uint32_t usbd_int_epout (usb_core_driver *udev)
{
    ...
    for (epintnum = usb_oepintnum_read (udev); epintnum; epintnum >>= 1, ep_num++) {
        if (epintnum & 0x01U) {
            volatile uint32_t oepintr = usb_oepintr_read (udev, ep_num);


            if (oepintr & ((uint32_t)((uint32_t)0x01U<<(0)))) {

                udev->regs.er_out[ep_num]->DOEPINTF = ((uint32_t)((uint32_t)0x01U<<(0)));
            ...
            if (oepintr & ((uint32_t)((uint32_t)0x01U<<(3)))) {

                (void)usbd_setup_transc (udev);

                udev->regs.er_out[ep_num]->DOEPINTF = ((uint32_t)((uint32_t)0x01U<<(3)));
            }
        }
    }
...
static uint32_t usbd_int_epin (usb_core_driver *udev)
{
    ...
    for (epintnum = usb_iepintnum_read (udev); epintnum; epintnum >>= 1, ep_num++) {
        if (epintnum & 0x1U) {
            volatile uint32_t iepintr = usb_iepintr_read (udev, ep_num);

            if (iepintr & ((uint32_t)((uint32_t)0x01U<<(0)))) {
                udev->regs.er_in[ep_num]->DIEPINTF = ((uint32_t)((uint32_t)0x01U<<(0)));


                (void)usbd_in_transc (udev, ep_num);
            }

            if (iepintr & ((uint32_t)((uint32_t)0x01U<<(7)))) {
                usbd_emptytxfifo_write (udev, (uint32_t)ep_num);

                udev->regs.er_in[ep_num]->DIEPINTF = ((uint32_t)((uint32_t)0x01U<<(7)));
            }
        }
    }
...
static uint32_t usbd_int_rxfifo (usb_core_driver *udev)
{
    ...
    volatile uint32_t devrxstat = 0U;
    ...
    uint8_t ep_num = (uint8_t)(devrxstat & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))));

    transc = &udev->dev.transc_out[ep_num];

    bcount = (devrxstat & ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(14))))) >> 4U;
    data_PID = (uint8_t)((devrxstat & ((0xFFFFFFFFUL << (15)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(16))))) >> 15U);

    switch ((devrxstat & ((0xFFFFFFFFUL << (17)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(20))))) >> 17U) {
    case 1U:
        break;
    ...
    case 6U:
        if ((0U == transc->ep_addr.num) && (8U == bcount) && (0U == data_PID)) {
...
static uint32_t usbd_int_reset (usb_core_driver *udev)
{
    ...
    udev->regs.dr->DOEPINTEN = ((uint32_t)((uint32_t)0x01U<<(3))) | ((uint32_t)((uint32_t)0x01U<<(0)));


    udev->regs.dr->DIEPINTEN = ((uint32_t)((uint32_t)0x01U<<(0)));
    ...
    udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(12)));
...
static uint32_t usbd_int_enumfinish (usb_core_driver *udev)
{
    uint8_t enum_speed = (uint8_t)((udev->regs.dr->DSTAT & ((0xFFFFFFFFUL << (1)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2))))) >> 1U);

    udev->regs.dr->DCTL &= ~((uint32_t)((uint32_t)0x01U<<(8)));
    udev->regs.dr->DCTL |= ((uint32_t)((uint32_t)0x01U<<(8)));

    udev->regs.gr->GUSBCS &= ~((0xFFFFFFFFUL << (10)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13))));
    ...
    udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(13)));
...
static uint32_t usbd_int_suspend (usb_core_driver *udev)
{
    volatile uint8_t low_power = udev->bp.low_power;
    volatile uint8_t suspend = (uint8_t)(udev->regs.dr->DSTAT & ((uint32_t)((uint32_t)0x01U<<(0))));
    volatile uint8_t is_configured = (udev->dev.cur_status == (uint8_t)USBD_CONFIGURED)? 1U : 0U;
    ...
    if (low_power && suspend && is_configured) {
        ...
        *udev->regs.PWRCLKCTL |= ((uint32_t)((uint32_t)0x01U<<(0))) | ((uint32_t)((uint32_t)0x01U<<(1)));
    ...
    udev->regs.gr->GINTF = ((uint32_t)((uint32_t)0x01U<<(11)));

    return 1U;
}
# 436 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usbd_int.c"
static uint32_t usbd_emptytxfifo_write (usb_core_driver *udev, uint32_t ep_num)
{
    uint32_t len;
    uint32_t word_count;
    ...
    while (((udev->regs.er_in[ep_num]->DIEPTFSTAT & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15))))) >= word_count) && (transc->xfer_count < transc->xfer_len)) {
