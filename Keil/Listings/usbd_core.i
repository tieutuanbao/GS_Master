# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c" 2
# 37 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
...
# 38 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_enum.h" 1
# 42 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_enum.h"
...
# 39 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c" 2
...
# 40 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c" 2
...
# 58 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
void usbd_init (usb_core_driver *udev, usb_core_enum core, usb_desc *desc, usb_class_core *class_core)
{
    udev->dev.desc = desc;
...
# 101 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_ep_setup (usb_core_driver *udev, const usb_desc_ep *ep_desc)
{
    usb_transc *transc;
    ...
    if (((uint8_t)((ep_addr) >> 7))) {
        transc = &udev->dev.transc_in[((uint8_t)((ep_addr) & 0x7FU))];
    ...
    transc->ep_addr.num = ((uint8_t)((ep_addr) & 0x7FU));
...
# 139 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_ep_clear (usb_core_driver *udev, uint8_t ep_addr)
{
    usb_transc *transc;
...
# 167 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_ep_recev (usb_core_driver *udev, uint8_t ep_addr, uint8_t *pbuf, uint32_t len)
{
    usb_transc *transc = &udev->dev.transc_out[((uint8_t)((ep_addr) & 0x7FU))];
...
# 194 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_ep_send (usb_core_driver *udev, uint8_t ep_addr, uint8_t *pbuf, uint32_t len)
{
    usb_transc *transc = &udev->dev.transc_in[((uint8_t)((ep_addr) & 0x7FU))];
...
# 219 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_ep_stall (usb_core_driver *udev, uint8_t ep_addr)
{
    usb_transc *transc = 0;
...
# 246 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_ep_stall_clear (usb_core_driver *udev, uint8_t ep_addr)
{
    usb_transc *transc = 0;
...
# 273 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_core.c"
uint32_t usbd_fifo_flush (usb_core_driver *udev, uint8_t ep_addr)
{
    if (((uint8_t)((ep_addr) >> 7))) {
        (void)usb_txfifo_flush (&udev->regs, ((uint8_t)((ep_addr) & 0x7FU)));
    } else {
