# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c" 2
# 37 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
...
# 38 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c" 2
...
# 39 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c" 2


static void usb_core_reset (usb_core_regs *usb_regs);
# 51 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
                           ...
                           usb_core_enum usb_core)
{
    ...
    case USB_CORE_ENUM_FS:
        usb_basic->base_reg = (uint32_t)0x50000000L;
    ...
    usb_basic->sof_enable = 1;
    usb_basic->low_power = 1;
    ...
    *usb_regs = (usb_core_regs) {
    ...
    for (uint8_t i = 0U; i < usb_basic->num_pipe; i++) {
        ...
        usb_regs->DFIFO[i] = (uint32_t *) (usb_basic->base_reg + 0x1000U + (i * 0x1000U));

    }

    return USB_OK;
}
# 123 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
usb_status usb_core_init (usb_core_basic usb_basic, usb_core_regs *usb_regs)
{
    if (1U == usb_basic.phy_itf) {
        usb_regs->gr->GCCFG &= ~((uint32_t)((uint32_t)0x01U<<(16)));

        if (usb_basic.sof_enable) {
            usb_regs->gr->GCCFG |= ((uint32_t)((uint32_t)0x01U<<(20)));
        }


        usb_regs->gr->GUSBCS &= ~(((uint32_t)((uint32_t)0x01U<<(6))) | ((uint32_t)((uint32_t)0x01U<<(21))));
        ...
        usb_regs->gr->GUSBCS &= ~((uint32_t)((uint32_t)0x01U<<(20)));



        usb_core_reset (usb_regs);
    } else {
        usb_regs->gr->GUSBCS |= ((uint32_t)((uint32_t)0x01U<<(6)));


        usb_core_reset (usb_regs);


        usb_regs->gr->GCCFG |= ((uint32_t)((uint32_t)0x01U<<(16))) | ((uint32_t)((uint32_t)0x01U<<(18))) | ((uint32_t)((uint32_t)0x01U<<(19)));


        usb_regs->gr->GCCFG |= ((uint32_t)((uint32_t)0x01U<<(21)));
...
# 179 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
    return USB_OK;
}
# 191 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
                             ...
                             uint16_t byte_count)
{
    ...
    volatile uint32_t *fifo = usb_regs->DFIFO[fifo_num];

    while (word_count-- > 0U) {
        *fifo = *((__attribute__ ((__packed__)) uint32_t *)src_buf);
...
# 217 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
void *usb_rxfifo_read (usb_core_regs *usb_regs, uint8_t *dest_buf, uint16_t byte_count)
{
    uint32_t word_count = (byte_count + 3U) / 4U;

    volatile uint32_t *fifo = usb_regs->DFIFO[0];

    while (word_count-- > 0U) {
        *(__attribute__ ((__packed__)) uint32_t *)dest_buf = *fifo;
...
# 239 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
usb_status usb_txfifo_flush (usb_core_regs *usb_regs, uint8_t fifo_num)
{
    usb_regs->gr->GRSTCTL = ((uint32_t)fifo_num << 6U) | ((uint32_t)((uint32_t)0x01U<<(5)));


    while (usb_regs->gr->GRSTCTL & ((uint32_t)((uint32_t)0x01U<<(5)))) {
...
usb_status usb_rxfifo_flush (usb_core_regs *usb_regs)
{
    usb_regs->gr->GRSTCTL = ((uint32_t)((uint32_t)0x01U<<(4)));


    while (usb_regs->gr->GRSTCTL & ((uint32_t)((uint32_t)0x01U<<(4)))) {
...
# 283 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/driver/Source/drv_usb_core.c"
void usb_set_txfifo(usb_core_regs *usb_regs, uint8_t fifo, uint16_t size)
{
    uint32_t tx_offset;
...
void usb_curmode_set(usb_core_regs *usb_regs, uint8_t mode)
{
    usb_regs->gr->GUSBCS &= ~(((uint32_t)((uint32_t)0x01U<<(30))) | ((uint32_t)((uint32_t)0x01U<<(29))));

    if (DEVICE_MODE == mode) {
        usb_regs->gr->GUSBCS |= ((uint32_t)((uint32_t)0x01U<<(30)));
    } else if (HOST_MODE == mode) {
        usb_regs->gr->GUSBCS |= ((uint32_t)((uint32_t)0x01U<<(29)));
    } else {
...
static void usb_core_reset (usb_core_regs *usb_regs)
{
    ...
    usb_regs->gr->GRSTCTL |= ((uint32_t)((uint32_t)0x01U<<(0)));


    while (usb_regs->gr->GRSTCTL & ((uint32_t)((uint32_t)0x01U<<(0)))) {
