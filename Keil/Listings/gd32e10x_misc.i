# 1 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c" 2
# 38 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
...
# 39 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c" 2
# 51 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
void nvic_priority_group_set(uint32_t nvic_prigroup)
{

    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR = ((uint32_t)0x05FA0000U) | nvic_prigroup;
}
# 65 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
                     ...
                     uint8_t nvic_irq_sub_priority)
{
    ...
    switch((((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR) & (uint32_t)0x700U) {
    case ((uint32_t)0x00000700U):
        temp_pre = 0U;
        temp_sub = 0x4U;
        break;
    case ((uint32_t)0x00000600U):
        temp_pre = 1U;
        temp_sub = 0x3U;
        break;
    case ((uint32_t)0x00000500U):
        temp_pre = 2U;
        temp_sub = 0x2U;
        break;
    case ((uint32_t)0x00000400U):
        temp_pre = 3U;
        temp_sub = 0x1U;
        break;
    case ((uint32_t)0x00000300U):
        temp_pre = 4U;
        temp_sub = 0x0U;
        break;
    default:
        nvic_priority_group_set(((uint32_t)0x00000500U));
        temp_pre = 2U;
        temp_sub = 0x2U;
        break;
    }
    ...
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IP[nvic_irq] = (uint8_t)temp_priority;
...
void nvic_irq_disable(uint8_t nvic_irq)
{
    ...
    ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICER[nvic_irq >> 0x05U] = (uint32_t)0x01U << (nvic_irq & (uint8_t)0x1FU);
}
# 131 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
void nvic_vector_table_set(uint32_t nvic_vict_tab, uint32_t offset)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = nvic_vict_tab | (offset & ((uint32_t)0x1FFFFF80U));
    __DSB();
}
# 148 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
void system_lowpower_set(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (uint32_t)lowpower_mode;
}
# 164 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
void system_lowpower_reset(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (~(uint32_t)lowpower_mode);
}
# 178 "../GD32E10x_Firmware_Library/GD32E10x_standard_peripheral/Source/gd32e10x_misc.c"
void systick_clksource_set(uint32_t systick_clksource)
{
