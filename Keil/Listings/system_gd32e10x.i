# 1 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c" 2
# 36 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c"
...
# 37 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c" 2
# 95 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c"
uint32_t SystemCoreClock = (uint32_t)(120000000);
...
void SystemInit (void)
{
    ...
    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(1))))){
    }
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1))));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) &= ~(((uint32_t)((uint32_t)0x01U<<(24))) |((uint32_t)((uint32_t)0x01U<<(26))) | ((uint32_t)((uint32_t)0x01U<<(28))) | ((uint32_t)((uint32_t)0x01U<<(19))) | ((uint32_t)((uint32_t)0x01U<<(16))));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x08U)) = 0x00ff0000U;


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) = 0x00000000U;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) = 0x00000000U;
  ...
  nvic_vector_table_set(((uint32_t)0x08000000U),0x00);
...
static void system_clock_config(void)
{
# 172 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c"
    system_clock_120m_hxtal();

}
# 713 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c"
static void system_clock_120m_hxtal(void)
{
    uint32_t timeout = 0U;
    ...
    do{
        timeout++;
        stab_flag = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17))));
    }while((0U == stab_flag) && (((uint16_t)0x0FFFF) != timeout));


    if(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(17))))){
        while(1){
        }
    }

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40018000U) + 0x0000A000U)) + 0x00000000U)) = ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40018000U) + 0x0000A000U)) + 0x00000000U)) & (~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))))) | (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(3)));



    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 4));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) |= (((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0) << 11));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(4) << 8));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) &= ~(((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) | ((uint32_t)((uint32_t)0x01U<<(29))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) |= (((uint32_t)((uint32_t)0x01U<<(16))) | (((uint32_t)((uint32_t)0x01U<<(29))) | (((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) & ((uint32_t)(13) << 18))));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) &= ~(((uint32_t)((uint32_t)0x01U<<(30))) | ((uint32_t)((uint32_t)0x01U<<(16))) | ((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) | ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) | ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) |= (((uint32_t)0x00000000U) | ((uint32_t)((uint32_t)0x01U<<(16))) | (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(8) << 8)) | (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(1) << 4)) | (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(9) << 0)));
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(26)));

    while(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(27)))) == 0U){
    }


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(24)));


    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(25))))){
    }


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0));


    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x04U)) & (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(2) << 2)))){
    }
}
# 785 "../GD32E10x_Firmware_Library/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c"
    ...
    case 0x02U:
        ...
        if(((uint32_t)((uint32_t)0x01U<<(16))) == pllsel){
            ...
            if(((uint32_t)((uint32_t)0x01U<<(16))) == predv0sel){
                predv1 = (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) & ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7))))) >> 4) + 1U;
                pll1mf = (((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40018000U) + 0x00009000U) + 0x2CU)) & ((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11))))) >> 8) + 2U;
                if(17U == pll1mf){
                    pll1mf = 20U;
                }
