# 1 "../RTT/RTT/SEGGER_RTT.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../RTT/RTT/SEGGER_RTT.c" 2
# 77 "../RTT/RTT/SEGGER_RTT.c"
...
static void _WriteNoCheck(SEGGER_RTT_BUFFER_UP* pRing, const char* pData, unsigned NumBytes) {
  ...
  if (Rem > NumBytes) {
    ...
    pDst = (pRing->pBuffer + WrOff) + (0);
# 463 "../RTT/RTT/SEGGER_RTT.c"
    memcpy(((void*)pDst), (pData), (NumBytes));
    __asm volatile ("dmb\n" : : :);;
    pRing->WrOff = WrOff + NumBytes;

  } else {
# 485 "../RTT/RTT/SEGGER_RTT.c"
    NumBytesAtOnce = Rem;
    pDst = (pRing->pBuffer + WrOff) + (0);
...
# 768 "../RTT/RTT/SEGGER_RTT.c"
unsigned SEGGER_RTT_ReadUpBuffer(unsigned BufferIndex, void* pBuffer, unsigned BufferSize) {
  unsigned NumBytesRead;

  { unsigned int _SEGGER_RTT__LockState; __asm volatile ("mrs   %0, basepri  \n\t" "mov   r1, %1       \n\t" "msr   basepri, r1  \n\t" : "=r" (_SEGGER_RTT__LockState) : "i"((0x20)) : "r1", "cc" );;
...
# 1906 "../RTT/RTT/SEGGER_RTT.c"
void SEGGER_RTT_Init (void) {
  _DoInit();
}
# 1927 "../RTT/RTT/SEGGER_RTT.c"
int SEGGER_RTT_SetTerminal (unsigned char TerminalId) {
  unsigned char ac[2];
  SEGGER_RTT_BUFFER_UP* pRing;
  unsigned Avail;
