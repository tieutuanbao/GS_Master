# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c" 2
# 38 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c"
...
# 39 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_transc.h" 1
# 44 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Include\\usbd_transc.h"
...
# 40 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c" 2
...
usbd_status usbd_ctl_status_send (usb_core_driver *udev)
{
    ...
    (void)usbd_ep_send (udev, 0U, 0, 0U);
...
usbd_status usbd_ctl_status_recev (usb_core_driver *udev)
{
    ...
    (void)usbd_ep_recev (udev, 0U, 0, 0U);
...
uint8_t usbd_setup_transc (usb_core_driver *udev)
{
    ...
    switch (req.bmRequestType & 0x60U) {
...
# 173 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c"
uint8_t usbd_out_transc (usb_core_driver *udev, uint8_t ep_num)
{
    if (0U == ep_num) {
        usb_transc *transc = &udev->dev.transc_out[0];
        ...
        case USB_CTL_LAST_DATA_OUT:
            if (udev->dev.cur_status == (uint8_t)USBD_CONFIGURED) {
                if (udev->dev.class_core->ctlx_out != 0) {
    ...
    } else if ((udev->dev.class_core->data_out != 0) && (udev->dev.cur_status == (uint8_t)USBD_CONFIGURED)) {
...
# 217 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_transc.c"
uint8_t usbd_in_transc (usb_core_driver *udev, uint8_t ep_num)
{
    if (0U == ep_num) {
        usb_transc *transc = &udev->dev.transc_in[0];
        ...
        case USB_CTL_LAST_DATA_IN:
            ...
            if (udev->dev.control.ctl_zlp) {
                ...
                if (udev->dev.cur_status == (uint8_t)USBD_CONFIGURED) {
                    if (udev->dev.class_core->ctlx_in != 0) {
        ...
        if ((udev->dev.cur_status == (uint8_t)USBD_CONFIGURED) && (udev->dev.class_core->data_in != 0)) {
