# 1 "../source/hid_keyboard_itf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../source/hid_keyboard_itf.c" 2
# 38 "../source/hid_keyboard_itf.c"
...
# 39 "../source/hid_keyboard_itf.c" 2
...
# 41 "../source/hid_keyboard_itf.c" 2
...
# 42 "../source/hid_keyboard_itf.c" 2
...
static void hid_key_data_send(usb_dev *udev) {
    ...
    hid_report_send(udev, hid->data, 64);
}
