# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 386 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c" 2
# 38 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
...
# 39 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c" 2
# 48 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
...
# 96 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
usb_reqsta usbd_standard_request (usb_core_driver *udev, usb_req *req)
{
    return (*_std_dev_req[req->bRequest])(udev, req);
}
# 108 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
usb_reqsta usbd_class_request (usb_core_driver *udev, usb_req *req)
{
    if ((uint8_t)USBD_CONFIGURED == udev->dev.cur_status) {
        if (((uint8_t)((req->wIndex) & 0x00FFU)) <= 1) {
...
# 127 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
usb_reqsta usbd_vendor_request (usb_core_driver *udev, usb_req *req)
{
    (void)udev;
    (void)req;
...
# 147 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
void usbd_enum_error (usb_core_driver *udev, usb_req *req)
{
    (void)req;
...
# 165 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
void int_to_unicode (uint32_t value, uint8_t *pbuf, uint8_t len)
{
    uint8_t index;
...
void serial_string_get (uint16_t *unicode_str)
{
    if ((unicode_str[0] & 0x00FFU) != 6U) {
        ...
        DeviceSerial0 = *(uint32_t*)(0x1FFFF7E8U);
        DeviceSerial1 = *(uint32_t*)(0x1FFFF7ECU);
        DeviceSerial2 = *(uint32_t*)(0x1FFFF7F0U);
        ...
        uint32_t device_serial = *(uint32_t*)(0x40022100U);
...
# 221 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_reserved (usb_core_driver *udev, usb_req *req)
{
    (void)udev;
    (void)req;
...
# 238 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static uint8_t* _usb_dev_desc_get (usb_core_driver *udev, uint8_t index, uint16_t *len)
{
    (void)index;
...
# 254 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static uint8_t* _usb_config_desc_get (usb_core_driver *udev, uint8_t index, uint16_t *len)
{
    (void)index;
...
# 270 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static uint8_t* _usb_bos_desc_get (usb_core_driver *udev, uint8_t index, uint16_t *len)
{
    (void)index;
...
# 286 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static uint8_t* _usb_str_desc_get (usb_core_driver *udev, uint8_t index, uint16_t *len)
{
...
# 302 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_getstatus (usb_core_driver *udev, usb_req *req)
{
    uint8_t recp = ((uint8_t)((req->wIndex) & 0x00FFU));
    ...
    case USB_RECPTYPE_DEV:
        if (((uint8_t)USBD_ADDRESSED == udev->dev.cur_status) || ((uint8_t)USBD_CONFIGURED == udev->dev.cur_status)) {
    ...
    case USB_RECPTYPE_ITF:
        if (((uint8_t)USBD_CONFIGURED == udev->dev.cur_status) && (recp <= 1)) {
            req_status = REQ_SUPP;
        }
        break;
    ...
    case USB_RECPTYPE_EP:
        if ((uint8_t)USBD_CONFIGURED == udev->dev.cur_status) {
            if (0x80U == (recp & 0x80U)) {
                status[0] = udev->dev.transc_in[((uint8_t)((recp) & 0x7FU))].ep_stall;
            } else {
...
# 368 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_clearfeature (usb_core_driver *udev, usb_req *req)
{
    uint8_t ep = 0U;
    ...
    case USB_RECPTYPE_EP:
        ...
        ep = ((uint8_t)((req->wIndex) & 0x00FFU));

        if ((uint8_t)USBD_CONFIGURED == udev->dev.cur_status) {

            if (((uint16_t)USB_FEATURE_EP_HALT == req->wValue) && (!(((ep) == 0x00U) || ((ep) == 0x80U)))) {
...
# 419 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_setfeature (usb_core_driver *udev, usb_req *req)
{
    uint8_t ep = 0U;
...
# 467 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_setaddress (usb_core_driver *udev, usb_req *req)
{
...
# 495 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_getdescriptor (usb_core_driver *udev, usb_req *req)
{
    ...
    case USB_RECPTYPE_DEV:
        desc_type = ((uint8_t)(((req->wValue) & 0xFF00U) >> 8U));
        desc_index = ((uint8_t)((req->wValue) & 0x00FFU));
...
# 579 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_setdescriptor (usb_core_driver *udev, usb_req *req)
{
    (void)udev;
    (void)req;
...
# 595 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_getconfiguration (usb_core_driver *udev, usb_req *req)
{
    (void)req;
    ...
    case USBD_ADDRESSED:
        if (0U == udev->dev.config) {
            req_status = REQ_SUPP;
        }
        break;

    case USBD_CONFIGURED:
        if (udev->dev.config != 0U) {
            req_status = REQ_SUPP;
        }
        break;
...
# 634 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_setconfiguration (usb_core_driver *udev, usb_req *req)
{
...
# 693 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_getinterface (usb_core_driver *udev, usb_req *req)
{
    switch (udev->dev.cur_status) {
    case USBD_DEFAULT:
...
# 727 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_setinterface (usb_core_driver *udev, usb_req *req)
{
    switch (udev->dev.cur_status) {
    case USBD_DEFAULT:
    ...
    case USBD_CONFIGURED:
        if (((uint8_t)((req->wIndex) & 0x00FFU)) <= 1) {
            if (0 != udev->dev.class_core->set_intf) {
...
# 760 "../GD32E10x_Firmware_Library/GD32E10x_usbfs_library/device/core/Source/usbd_enum.c"
static usb_reqsta _usb_std_synchframe (usb_core_driver *udev, usb_req *req)
{
    (void)udev;
    (void)req;
