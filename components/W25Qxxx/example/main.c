 ...
 * @return W25Q_stt_t
 */
W25Q_stt_t flash_w25qxx_drv_read(uint8_t *buff_to_read, uint32_t size) {
 ...
 * @return W25Q_stt_t
 */
W25Q_stt_t flash_w25qxx_drv_write(uint8_t *buff_to_write, uint32_t size) {
...
void main() {
    W25Q_init(&w25q_flash, flash_w25qxx_drv_read, flash_w25qxx_drv_write, flash_w25qxx_cs_control, delay_ms);
